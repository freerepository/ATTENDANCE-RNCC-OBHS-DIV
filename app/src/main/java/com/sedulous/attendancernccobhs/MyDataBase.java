...
import com.sedulous.attendancernccobhs.Models.AtDataModel;
...
public class MyDataBase {
    ...
    private String CREATE_TABLE_USER = String.format(" Create Table IF NOT EXISTS %s (%s integer PRIMARY KEY AUTOINCREMENT," +
            ...
            TABLE_USER, O.ID, O.USER_ID, O.STATION_CODE, O.USER_NAME, O.USER_TYPE,O.SKILLED_TYPE, O.LOGIN_METHOD, O.PASSWORD, O.PHONE, O.EMAIL, O.ADDRESS,
    ...
    public long insertToUser(String user_id, String unit_id, String name, String utype, String skilled_type, String login_method,
                             String password, String phone, String email, String address, String police_verification,
    ...
    public UserDataModel getUserData(String user_id) {
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                cursor.getString(cursor.getColumnIndex(O.EMAIL)),
