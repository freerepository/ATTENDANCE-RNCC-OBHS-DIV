...
public class UserDataModel implements Serializable {
    ...
    public String id, user_id, station_code, user_name, user_type, skilled_type, login_method, password, phone, email, address,
    ...
    public UserDataModel(String id, String user_id, String station_code, String user_name, String user_type, String skilled_type, String login_method,
        ...
        this.skilled_type=skilled_type; this.login_method=login_method; this.password=password; this.phone=phone; this.email=email; this.address=address;
